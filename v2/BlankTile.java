...
public class BlankTile implements GameTile{
	...
	public BlankTile(final Color color) {
		this(color, color);
	}

	public BlankTile(final Color strokeColor, final Color fillColor) {
		this(strokeColor, fillColor, 1.0);
	}

	public BlankTile(final Color strokeColor, final Color fillColor, final double thickness) {
